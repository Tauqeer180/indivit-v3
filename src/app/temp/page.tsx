...
import Fructover1 from './components/fructover1'

export default function page() {
  return (
    <div className="container tw-mt-28">
...
},
{
	...
	"description": "3-Tage Detox mit individuellen Smoothies: Weniger Zucker, mehr Nährstoffe & 4 Ausführungen für Entgiftung oder Reset. Frisch geliefert.",
