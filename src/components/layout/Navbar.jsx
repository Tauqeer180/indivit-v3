                ...
                <div id="navbarExampleOnHover" className="mx-2">
                  <ul className="navbar-nav">
                    ...
                    <li className="nav-item ">
                      <a
                        className="nav-link dropdown-toggle tw-font-Epilogue-bold !tw-font-semibold"
                        role="button"
                        id="shopDropdown"
              ...
              <ul className="navbar-nav justify-content-md-end justify-content-center">
                ...
                <li className="nav-item d-flex align-items-center">
                  ...
                  <Link href="/meine-wunschliste" className="position-relative hsn-border">
                    ...
                    <span className="tw-absolute tw-right-0 tw-top-0 -tw-translate-y-1/2 badge rounded-pill hsn-badge">
                      {wishlistCount}
                    </span>
                  </Link>
